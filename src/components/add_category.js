            ...
            <div className="jumbotron col-sm-8">
                <form onSubmit={this.addCategory} id="category-form">
                    <div className="form-group">
                        <input type="text" className="form-control" placeholder="Category name" id="cat_name" value={this.state.cat_name} onChange={this.handleCatNameChange} required/>
                    </div>
                    <div className="form-group">
                        <input type="text" className="form-control" placeholder="Category description" id="cat_desc" value={this.state.cat_desc} onChange={this.handleCatDescChange} required/>
                    </div>
